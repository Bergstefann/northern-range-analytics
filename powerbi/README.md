...
Setup guide, DAX measures, and the M query to skip the Get Data wizard: see
`../docs/power-bi-measures.md`.

This folder is where the built report and its screenshots go once someone with Power BI
Desktop builds it:

- `NorthernRangeAnalytics.pbix` — the report file itself. Not built yet; see
